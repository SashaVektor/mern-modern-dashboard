...
export const api = createApi({
    ...
    tagTypes: ["User", "Products", "Customers", "Transactions",
        "Geography", "Sales", "Admins", "Perfomance", "Dashboard"],
    endpoints: (build) => ({
        getUser: build.query({
        ...
        getPerfomance: build.query({
            query: (id) => `/managment/perfomance/${id}`,
...
export const {
    ...
    useGetGeographyQuery, useGetSalesQuery, useGetAdminsQuery, useGetPerfomanceQuery,
