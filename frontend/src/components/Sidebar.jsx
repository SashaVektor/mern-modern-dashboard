...
import {
    Settings, ChevronLeft, ChevronRightOutlined, HomeOutlined,
    ShoppingCartOutlined, Groups2Outlined, ReceiptOutlined,
    PublicOutlined, PointOfSaleOutlined, TodayOutlined, CalendarMonthOutlined,
    AdminPanelSettingsOutlined, TrendingUp, PieChartOutline, TrendingUpOutlined, PieChartOutlined, ReceiptLongOutlined
...
const Sidebar = ({ drawerWidth, isOpen, setIsOpen, isNonMobile, user }) => {
